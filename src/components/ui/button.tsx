  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // BlueprintHub custom variants
        accent: "bg-accent text-accent-foreground hover:bg-accent/90 glow-accent active:scale-[0.98]",
        hero: "bg-accent text-accent-foreground hover:bg-accent/90 glow-accent font-semibold active:scale-[0.98] shadow-lg",
        "hero-outline": "border-2 border-primary bg-transparent text-primary hover:bg-primary hover:text-primary-foreground font-semibold active:scale-[0.98]",
